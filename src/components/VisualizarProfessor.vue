<template>
  <div class="container">
    <h1 class="mb-3 mt-4">Consultar Professor</h1>
...
export default {
  ...
  methods: {
    deletar(id) {
      ...
      var url = "http://localhost:8090/api/deletarCoordenador/" + id;
      axios
        .delete(url, {
          headers: {
            Authorization: token,
    ...
    onSubmit(event) {
      ...
      var token = VueCookies.get("token");
      // console.log(token);
      var url = "http://localhost:8090/api/atualizarProfessor/";
      axios
        .put(url, coordenador, {
          headers: {
            Authorization: token,
        ...
        .then(function (response) {
          ...
          if (response.status == 200) {
            alert("Professores Atualizado com Sucesso!");
          }
        })
        .catch(function (error) {
          console.log(error);
  ...
  mounted() {
    ...
    var temp = [];
    var token = VueCookies.get("token");
    var url = "http://localhost:8090/api/professores/";
