<template>
  <div class="container">
    <h1 class="mb-3 mt-4">Cadastrar Professor</h1>
    ...
    <div>
      <b-form @submit="onSubmit" @reset="onReset" v-if="show">
        <b-card bg-variant="light">
          <b-form-group
            label-cols-lg="4"
            label="Dados Pessoais do Professor"
            label-size="lg"
        ...
        <b-card bg-variant="light" class="mt-3">
          <b-form-group
            label-cols-lg="4"
            label="Dados do endereço do Professor"
            label-size="lg"
            label-class="font-weight-bold pt-0"
            class="mb-0"
            label-align="left"
...
export default {
  ...
  methods: {
    onSubmit(event) {
      ...
      var url = "http://localhost:8090/api/cadastrarProfessor/";
